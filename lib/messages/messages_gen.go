...
// DecodeMsg implements msgp.Decodable
func (z *PlayerStrafedMsg) DecodeMsg(dc *msgp.Reader) (err error) {
	var field []byte
	_ = field
	var zb0001 uint32
	zb0001, err = dc.ReadMapHeader()
...
// EncodeMsg implements msgp.Encodable
func (z PlayerStrafedMsg) EncodeMsg(en *msgp.Writer) (err error) {
	// map header, size 2
	// write "id"
	err = en.Append(0x82, 0xa2, 0x69, 0x64)
	if err != nil {
	...
	// write "str"
	err = en.Append(0xa3, 0x73, 0x74, 0x72)
	if err != nil {
		return
	}
...
// MarshalMsg implements msgp.Marshaler
func (z PlayerStrafedMsg) MarshalMsg(b []byte) (o []byte, err error) {
	o = msgp.Require(b, z.Msgsize())
	// map header, size 2
	// string "id"
	o = append(o, 0x82, 0xa2, 0x69, 0x64)
...
// UnmarshalMsg implements msgp.Unmarshaler
func (z *PlayerStrafedMsg) UnmarshalMsg(bts []byte) (o []byte, err error) {
	var field []byte
	_ = field
	var zb0001 uint32
	zb0001, bts, err = msgp.ReadMapHeaderBytes(bts)
...
// Msgsize returns an upper bound estimate of the number of bytes occupied by the serialized message
func (z PlayerStrafedMsg) Msgsize() (s int) {
	s = 1 + 3 + msgp.StringPrefixSize + len(z.ID) + 4 + msgp.BoolSize
	return
}
...
// DecodeMsg implements msgp.Decodable
func (z *PlayerTurnedMsg) DecodeMsg(dc *msgp.Reader) (err error) {
	var field []byte
	_ = field
	var zb0001 uint32
	zb0001, err = dc.ReadMapHeader()
...
// EncodeMsg implements msgp.Encodable
func (z *PlayerTurnedMsg) EncodeMsg(en *msgp.Writer) (err error) {
	// map header, size 2
	// write "id"
	err = en.Append(0x82, 0xa2, 0x69, 0x64)
	if err != nil {
...
// MarshalMsg implements msgp.Marshaler
func (z *PlayerTurnedMsg) MarshalMsg(b []byte) (o []byte, err error) {
	o = msgp.Require(b, z.Msgsize())
	// map header, size 2
	// string "id"
	o = append(o, 0x82, 0xa2, 0x69, 0x64)
...
// UnmarshalMsg implements msgp.Unmarshaler
func (z *PlayerTurnedMsg) UnmarshalMsg(bts []byte) (o []byte, err error) {
	var field []byte
	_ = field
	var zb0001 uint32
	zb0001, bts, err = msgp.ReadMapHeaderBytes(bts)
...
// Msgsize returns an upper bound estimate of the number of bytes occupied by the serialized message
func (z *PlayerTurnedMsg) Msgsize() (s int) {
	s = 1 + 3 + msgp.StringPrefixSize + len(z.ID) + 4 + z.Dir.Msgsize()
	return
}

// DecodeMsg implements msgp.Decodable
func (z *StrafeMsg) DecodeMsg(dc *msgp.Reader) (err error) {
	var field []byte
	_ = field
	var zb0001 uint32
	zb0001, err = dc.ReadMapHeader()
...
// EncodeMsg implements msgp.Encodable
func (z StrafeMsg) EncodeMsg(en *msgp.Writer) (err error) {
	// map header, size 1
	// write "str"
...
// MarshalMsg implements msgp.Marshaler
func (z StrafeMsg) MarshalMsg(b []byte) (o []byte, err error) {
	o = msgp.Require(b, z.Msgsize())
	// map header, size 1
	// string "str"
...
// UnmarshalMsg implements msgp.Unmarshaler
func (z *StrafeMsg) UnmarshalMsg(bts []byte) (o []byte, err error) {
	var field []byte
	_ = field
	var zb0001 uint32
	zb0001, bts, err = msgp.ReadMapHeaderBytes(bts)
...
// Msgsize returns an upper bound estimate of the number of bytes occupied by the serialized message
func (z StrafeMsg) Msgsize() (s int) {
	s = 1 + 4 + msgp.BoolSize
	return
}

// DecodeMsg implements msgp.Decodable
func (z *TurnMsg) DecodeMsg(dc *msgp.Reader) (err error) {
	var field []byte
	_ = field
	var zb0001 uint32
	zb0001, err = dc.ReadMapHeader()
...
// EncodeMsg implements msgp.Encodable
func (z *TurnMsg) EncodeMsg(en *msgp.Writer) (err error) {
	// map header, size 1
	// write "dir"
	err = en.Append(0x81, 0xa3, 0x64, 0x69, 0x72)
	if err != nil {
...
// MarshalMsg implements msgp.Marshaler
func (z *TurnMsg) MarshalMsg(b []byte) (o []byte, err error) {
	o = msgp.Require(b, z.Msgsize())
	// map header, size 1
	// string "dir"
	o = append(o, 0x81, 0xa3, 0x64, 0x69, 0x72)
...
// UnmarshalMsg implements msgp.Unmarshaler
func (z *TurnMsg) UnmarshalMsg(bts []byte) (o []byte, err error) {
	var field []byte
	_ = field
	var zb0001 uint32
	zb0001, bts, err = msgp.ReadMapHeaderBytes(bts)
	...
	for zb0001 > 0 {
		...
		case "MoveMsg":
			...
			for zb0002 > 0 {
				...
				switch msgp.UnsafeString(field) {
				case "dir":
					err = z.MoveMsg.Dir.DecodeMsg(dc)
					if err != nil {
...
func (z *UdpMoveMsg) EncodeMsg(en *msgp.Writer) (err error) {
	...
	err = z.MoveMsg.Dir.EncodeMsg(en)
	if err != nil {
		err = msgp.WrapError(err, "MoveMsg", "Dir")
		return
	}
...
func (z *UdpMoveMsg) MarshalMsg(b []byte) (o []byte, err error) {
	...
	// string "dir"
	o = append(o, 0x81, 0xa3, 0x64, 0x69, 0x72)
	o, err = z.MoveMsg.Dir.MarshalMsg(o)
	if err != nil {
		err = msgp.WrapError(err, "MoveMsg", "Dir")
		return
	}
	...
	for zb0001 > 0 {
		...
		case "MoveMsg":
			...
			for zb0002 > 0 {
				...
				switch msgp.UnsafeString(field) {
				case "dir":
					bts, err = z.MoveMsg.Dir.UnmarshalMsg(bts)
					if err != nil {
						err = msgp.WrapError(err, "MoveMsg", "Dir")
						return
					}
...
func (z *UdpMoveMsg) Msgsize() (s int) {
	s = 1 + 17 + z.ClientUDPMessage.Msgsize() + 8 + 1 + 4 + z.MoveMsg.Dir.Msgsize()
	return
}
