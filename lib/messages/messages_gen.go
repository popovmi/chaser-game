...
func (z *BoostMsg) DecodeMsg(dc *msgp.Reader) (err error) {
	var field []byte
	_ = field
	var zb0001 uint32
...
func (z BoostMsg) EncodeMsg(en *msgp.Writer) (err error) {
	// map header, size 1
	// write "boosting"
	err = en.Append(0x81, 0xa8, 0x62, 0x6f, 0x6f, 0x73, 0x74, 0x69, 0x6e, 0x67)
	if err != nil {
		return
	}
...
func (z BoostMsg) MarshalMsg(b []byte) (o []byte, err error) {
	o = msgp.Require(b, z.Msgsize())
	// map header, size 1
	// string "boosting"
	o = append(o, 0x81, 0xa8, 0x62, 0x6f, 0x6f, 0x73, 0x74, 0x69, 0x6e, 0x67)
	o = msgp.AppendBool(o, z.Boosting)
	return
}

// UnmarshalMsg implements msgp.Unmarshaler
func (z *BoostMsg) UnmarshalMsg(bts []byte) (o []byte, err error) {
	var field []byte
	_ = field
	var zb0001 uint32
	...
	for zb0001 > 0 {
		...
		case "g":
			if dc.IsNil() {
				...
				if z.Game == nil {
					z.Game = new(game.Game)
				}
				err = z.Game.DecodeMsg(dc)
				if err != nil {
					err = msgp.WrapError(err, "Game")
					return
				}
...
func (z *GameStateMsg) MarshalMsg(b []byte) (o []byte, err error) {
	...
	// map header, size 1
	// string "g"
	o = append(o, 0x81, 0xa1, 0x67)
	if z.Game == nil {
		o = msgp.AppendNil(o)
	} else {
		o, err = z.Game.MarshalMsg(o)
		if err != nil {
			err = msgp.WrapError(err, "Game")
			return
		}
	...
	for zb0001 > 0 {
		...
		case "g":
			if msgp.IsNil(bts) {
				...
				bts, err = z.Game.UnmarshalMsg(bts)
				if err != nil {
					err = msgp.WrapError(err, "Game")
					return
				}
...
// DecodeMsg implements msgp.Decodable
func (z *PlayerBlinkedMsg) DecodeMsg(dc *msgp.Reader) (err error) {
	var field []byte
	_ = field
	var zb0001 uint32
	zb0001, err = dc.ReadMapHeader()
...
// EncodeMsg implements msgp.Encodable
func (z PlayerBlinkedMsg) EncodeMsg(en *msgp.Writer) (err error) {
	// map header, size 1
	// write "id"
...
// MarshalMsg implements msgp.Marshaler
func (z PlayerBlinkedMsg) MarshalMsg(b []byte) (o []byte, err error) {
	o = msgp.Require(b, z.Msgsize())
	// map header, size 1
	// string "id"
...
// UnmarshalMsg implements msgp.Unmarshaler
func (z *PlayerBlinkedMsg) UnmarshalMsg(bts []byte) (o []byte, err error) {
	var field []byte
	_ = field
	var zb0001 uint32
	zb0001, bts, err = msgp.ReadMapHeaderBytes(bts)
...
// Msgsize returns an upper bound estimate of the number of bytes occupied by the serialized message
func (z PlayerBlinkedMsg) Msgsize() (s int) {
	s = 1 + 3 + msgp.StringPrefixSize + len(z.ID)
	return
}

// DecodeMsg implements msgp.Decodable
func (z *PlayerBoostedMsg) DecodeMsg(dc *msgp.Reader) (err error) {
	var field []byte
	_ = field
	var zb0001 uint32
	zb0001, err = dc.ReadMapHeader()
...
// EncodeMsg implements msgp.Encodable
func (z PlayerBoostedMsg) EncodeMsg(en *msgp.Writer) (err error) {
	// map header, size 2
	// write "id"
	...
	// write "boosting"
	err = en.Append(0xa8, 0x62, 0x6f, 0x6f, 0x73, 0x74, 0x69, 0x6e, 0x67)
	if err != nil {
		return
	}
	err = en.WriteBool(z.Boosting)
...
// MarshalMsg implements msgp.Marshaler
func (z PlayerBoostedMsg) MarshalMsg(b []byte) (o []byte, err error) {
	o = msgp.Require(b, z.Msgsize())
	// map header, size 2
	// string "id"
	...
	o = msgp.AppendString(o, z.ID)
	// string "boosting"
	o = append(o, 0xa8, 0x62, 0x6f, 0x6f, 0x73, 0x74, 0x69, 0x6e, 0x67)
	o = msgp.AppendBool(o, z.Boosting)
	return
}

// UnmarshalMsg implements msgp.Unmarshaler
func (z *PlayerBoostedMsg) UnmarshalMsg(bts []byte) (o []byte, err error) {
	var field []byte
	_ = field
	var zb0001 uint32
	zb0001, bts, err = msgp.ReadMapHeaderBytes(bts)
...
// Msgsize returns an upper bound estimate of the number of bytes occupied by the serialized message
func (z PlayerBoostedMsg) Msgsize() (s int) {
	s = 1 + 3 + msgp.StringPrefixSize + len(z.ID) + 9 + msgp.BoolSize
	return
}
...
// DecodeMsg implements msgp.Decodable
func (z *PlayerHookedMsg) DecodeMsg(dc *msgp.Reader) (err error) {
	var field []byte
	_ = field
	var zb0001 uint32
	zb0001, err = dc.ReadMapHeader()
...
// EncodeMsg implements msgp.Encodable
func (z PlayerHookedMsg) EncodeMsg(en *msgp.Writer) (err error) {
	// map header, size 1
	// write "id"
	err = en.Append(0x81, 0xa2, 0x69, 0x64)
	if err != nil {
...
// MarshalMsg implements msgp.Marshaler
func (z PlayerHookedMsg) MarshalMsg(b []byte) (o []byte, err error) {
	o = msgp.Require(b, z.Msgsize())
	// map header, size 1
	// string "id"
	o = append(o, 0x81, 0xa2, 0x69, 0x64)
...
// UnmarshalMsg implements msgp.Unmarshaler
func (z *PlayerHookedMsg) UnmarshalMsg(bts []byte) (o []byte, err error) {
	var field []byte
	_ = field
	var zb0001 uint32
	zb0001, bts, err = msgp.ReadMapHeaderBytes(bts)
...
// Msgsize returns an upper bound estimate of the number of bytes occupied by the serialized message
func (z PlayerHookedMsg) Msgsize() (s int) {
	s = 1 + 3 + msgp.StringPrefixSize + len(z.ID)
	return
}
...
// DecodeMsg implements msgp.Decodable
func (z *PlayerRotatedMsg) DecodeMsg(dc *msgp.Reader) (err error) {
	var field []byte
	_ = field
	var zb0001 uint32
	zb0001, err = dc.ReadMapHeader()
...
// EncodeMsg implements msgp.Encodable
func (z *PlayerRotatedMsg) EncodeMsg(en *msgp.Writer) (err error) {
	// map header, size 2
	// write "id"
	err = en.Append(0x82, 0xa2, 0x69, 0x64)
	if err != nil {
...
// MarshalMsg implements msgp.Marshaler
func (z *PlayerRotatedMsg) MarshalMsg(b []byte) (o []byte, err error) {
	o = msgp.Require(b, z.Msgsize())
	// map header, size 2
	// string "id"
	o = append(o, 0x82, 0xa2, 0x69, 0x64)
...
// UnmarshalMsg implements msgp.Unmarshaler
func (z *PlayerRotatedMsg) UnmarshalMsg(bts []byte) (o []byte, err error) {
	var field []byte
	_ = field
	var zb0001 uint32
	zb0001, bts, err = msgp.ReadMapHeaderBytes(bts)
	...
	for zb0001 > 0 {
		...
		case "dir":
			bts, err = z.Dir.UnmarshalMsg(bts)
			if err != nil {
				err = msgp.WrapError(err, "Dir")
				return
			}
...
// Msgsize returns an upper bound estimate of the number of bytes occupied by the serialized message
func (z *PlayerRotatedMsg) Msgsize() (s int) {
	s = 1 + 3 + msgp.StringPrefixSize + len(z.ID) + 4 + z.Dir.Msgsize()
	return
}
...
// DecodeMsg implements msgp.Decodable
func (z *RotateMsg) DecodeMsg(dc *msgp.Reader) (err error) {
	var field []byte
	_ = field
	var zb0001 uint32
	zb0001, err = dc.ReadMapHeader()
...
// EncodeMsg implements msgp.Encodable
func (z *RotateMsg) EncodeMsg(en *msgp.Writer) (err error) {
	// map header, size 1
	// write "dir"
	err = en.Append(0x81, 0xa3, 0x64, 0x69, 0x72)
	if err != nil {
...
// MarshalMsg implements msgp.Marshaler
func (z *RotateMsg) MarshalMsg(b []byte) (o []byte, err error) {
	o = msgp.Require(b, z.Msgsize())
	// map header, size 1
	// string "dir"
	o = append(o, 0x81, 0xa3, 0x64, 0x69, 0x72)
...
// UnmarshalMsg implements msgp.Unmarshaler
func (z *RotateMsg) UnmarshalMsg(bts []byte) (o []byte, err error) {
	var field []byte
	_ = field
	var zb0001 uint32
	zb0001, bts, err = msgp.ReadMapHeaderBytes(bts)
...
// Msgsize returns an upper bound estimate of the number of bytes occupied by the serialized message
func (z *RotateMsg) Msgsize() (s int) {
	s = 1 + 4 + z.Dir.Msgsize()
	return
}
